...
let personName: string = "Nimra khan";
...
let personame: string = "\t\n  Nimoo khan! \n\t";
 console.log("original:", personame);
 console.log("strippped:", personame.trim());
...
//your programs are too simple at this point, just add your name and the current date at the top of each program file.Then write one sentence describing what the program does.
author: [Nimoo ; khan]
date: [saturDay , feburary 24 , 2024]
tsk 09: printing my favourite number.
let favouritenumber: number = 7;
reveling my favouritenumber in a message formate.
...
console.log(["zohaib", "shahzaib", "Umar", " khan"][0]);
console.log(["zohaib", "shahzaib", "Umar", " khan"][1]);
 console.log(["zohaib", "shahzaib", "Umar", " khan"][2]);
 console.log(["zohaib", "shahzaib", "Umar", " khan"][3]);
...
let names: string[] = ["zohaib", "shahzaib", "Umar", " khan"];

let message: string ="Do you like play football?"
...
let transportation: string[] = ["honda motocyle", "audi", "honda city"];
...
let Guestarr: string[] = ["kamran tessori", "Zia khan", "Daniyal nagori"];
 Guestarr.map((Items) => (console.log(`Dear sir ${Items} ; you are invited to the dinner`)));


// //"heading 15"
// //Changing Guest List: You just heard that one of your guests can’t make the dinner, so you need to send out a new set of invitations.
let gusestarr: string[] = ["sani", "kamran tessori", "zia khan", "Daniyal nagori"];
 let connotattend: string = "sani"
console.log(connotattend +" ""Can not attend the dinner.");
//You’ll have to think of someone else to invite.
let newguestarr: string = "Nimra"
 gusestarr [gusestarr.indexOf(connotattend)] = newguestarr;
console.log(gusestarr)
//• Start with your program from Exercise 14. Add a print statement at the end of your program stating the name of the guest who can’t make it.
//ify your list, replacing the name of the guest who can’t make it with the name of the new person you are inviting.
...
//bigger dinner table.
 let Gusestarr: string[] = ["kamran tessori", "zia khan", "khan" ,"daniyal nagori"];
let connotAttend : string = "khan"
let Newguest: string = "nimra"
Gusestarr[Gusestarr.indexOf(connotAttend)] = Newguest;
 console.log(Gusestarr)
Gusestarr.map((Items) => console.log(`dear sir ${Items}, i found bigger dinner table so I am invited more people.`));
//• Add one new guest to the beginning of your array.
// "part 02"
let newguestbeg: string = "moiz"
Gusestarr.unshift(newguestbeg);
 console.log(Gusestarr)
// //• Add one new guest to the middle of your array. • Use append() to add one new guest to the end of your list.
//"part 03 middle"
 let middleguest: string = "iqra"
 let MIDDLEINDEX = Gusestarr.length/3
 Gusestarr.splice(MIDDLEINDEX,3, middleguest)
console.log(Gusestarr)
...
// " part 04 append"
 Gusestarr.push("zeeshan")
console.log(Gusestarr)
//Print a new set of invitation messages, one for each person in your list.
//"part 05"
 Gusestarr.map((Items) => console.log(`dear ${Items}, you are invited in the more people list on dinner`));
...
// only two guests.• Start with  yourprogram from Exercise 16. Add a new line that prints a message saying that you can invite only two people for dinner.
// "initial list of guests"
let guest: string[] = ["ali","carry", "bilal", "hamza","dawood",];
// "informing  that only two people can be invited "
console.log("due to limited space, only two people can be invited for dinner.");
//• Remove guests from your list one at a time until only two names remain in your list.
// Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them to dinner.
// " romeving guests until only two name remain"
//• Print a message to each of the two people still on your list, letting them know they’re still invited.
while (guests.length > 2) {
const removedguest = guests.pop();
  console.log(`sorry, ${removedguest}, you're no longer invited to dinner.`)};
  let guests : string[] = ["ali", "carry",];

// // // printing invitations  to the remaining two list
...
let placestoVisit: string[] = ["tokyo", "pakistan", "london", "china", "japan"];
...
let invitations: string[] = ["ali", "carry"];
...
let country: string[] = ["pakstan", "india", "newyork", "japan", "china"];
...
name: "NIMRA", fname: "female", age: 20}
console.log(person)


// //"heading 22";
// // //Intentional Error: If you haven’t received an array
// //index error in one of your programs yet, try to make one happen.Change an
...
// // 05"true";
console.log("is car != 'TESLA'? predict true")
...
// //05"false";
console.log("is car == 'tesla'? predict false")
console.log(car == 'tesla')
...
let name_2: string = "Nimoo"
let name_3: string = "Nimoo khan"
...
if (!country.includes("turky")) {
 console.log("turky is not include in an array")
}
...
let favorite_fruits: string[] = ["orange", "cherry", "dragonrfruit","grape","apple"];
...
if (favorite_fruits.includes("dragonrfruit")) {
console.log("dragonrfruit")
}
...
let users : string [] = ["eric","umar", "shah" , "nimra", "admin"]
...
let current_users : string [] = ["admin", "Eric", "Khan", "Zaib", "nimoo"]
let new_users : string [] = ["admin", "nimoo", "Umar", "Zohaib", "Shah"]
...
let favorite_pizza : string [] = ["pepperoni" , "chicken" , "veg" , "gigle garlic gusto"]
...
console.log("\n all of these are gteat pets! but i love cats more")
...
console.log(` you oder a ${size} shirt that says ${text}`)
}
...
let album = makeAlbum("khan" , "light")
console.log(album)

album = makeAlbum("zaib" , "red wave")
console.log(album)

album = makeAlbum("awais" , "seenbreez")
console.log(album)
...
const magician: string[] = ["shah", "khan", "zaib"];
...
const magicians2: string[] = ["shah", "khan", "zaib"];
...
const magicians3: string[] = ["shah", "khan", "zaib"];
...
console.log("Enjoy your sandwich nimoo khan")
...
const Mycar: car = creatCar("toyota" , "corolla" , {color: "black" , year: "2024"}) 
console.log(Mycar)
